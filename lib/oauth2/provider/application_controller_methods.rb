    ...
    module ApplicationControllerMethods
      ...
      def user_id_for_oauth_access_token
        ...
        if looks_like_oauth_request?
          ...
          token = OauthToken.find_one(:access_token, oauth_token_from_request)
      ...
      def oauth_token_from_query_string
        params[:access_token]
      end
      
      def oauth_token_from_request
        oauth_token_from_query_string || oauth_token_from_request_header
      end

      def looks_like_oauth_request?
        !!oauth_token_from_request
      end
